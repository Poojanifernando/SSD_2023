...
export default class AdminViewSalary extends Component {
      ...
      <div>
        ...
        <div style={{ marginTop: '54px',  backgroundImage: `url(${BgAdmin2})`,   backgroundSize: 'cover'}}>
            ...
            <br/><br/>
                            ...
                            <br></br>
                            <p > *Enter The Employee Name/ID You Want To Find A Record</p>
                    ...
                    <a href="/AdminCreateSalary"
                    style={{textDecoration:'none',backgroundColor:'#051094',color:'white',fontSize:'17px'}}> 
                    <i class="fa-sharp fa-solid fa-circle-plus"></i>&nbsp;Create New Sheet</a>
                    </button>

                    <button className="btn btn-success" style={{padding:'9px 9px',backgroundColor:'#051094', marginLeft:'770px', marginTop:'80px'}}>
                    <a href="/AdminCheckAttendance"
                    style={{textDecoration:'none',backgroundColor:'#051094',color:'white',fontSize:'17px'}}> 
                <i class="fa-sharp fa-solid fa-clipboard-user"></i>&nbsp;Check Employee Attendace</a>
                    </button>
                    ...
                    <br/> 
                        <table className="table table-hover" style={{marginTop:'50px',  marginLeft:'170px', width:'1300px'}}>
                            ...
                            <tbody>
                                ...
                                <td><a href={`/ViewOneSalary/${GetAllSalary._id}`} style={{textDecoration:'none' }}>
                                ...
                                <td>
                                <a className ="btn btn-warning" href={`/AdminUpdateSalary/${GetAllSalary._id}`}>
